...
const submit = () => form.put(`/admin/cinemas/${cinema.id}`);

const handleDelete = () => router.delete(`/admin/cinemas/${cinema.id}`);

const handleAdmin = (newId) =>
    router.patch(`/admin/cinemas/${cinema.id}/admin`, { newId });
...
<template>
    ...
    <section class="m-8">
        ...
        <MultiSelect :data="endUsers" :cinema_id="cinema.id" />
    </section>
        ...
        <div class="m-8">
            ...
            >
                ...
                <div class="ml-auto flex gap-x-4">
                    <PrimaryButton
                        v-if="user.roles[0].role_name !== 'cinema_admin'"
                        @click="handleAdmin(user.id)"
                        >Promover a Admin</PrimaryButton
                    >
                    <p>X</p>
                </div>
            </div>
